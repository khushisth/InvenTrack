...
/**
 * Data access for {@code users} and role information.
 *
 * <p>This DAO stores BCrypt password hashes (see {@link com.inventrack.util.PasswordUtil}).</p>
 */
public class UserDAO implements UserInterface {
    ...
    public boolean registerUser(User user) {
        ...
        try (Connection conn = DBConnection.getConnection();
            ...
            // Step 2: Approve admin users automatically; require approval for other roles.
    ...
    public User getUserByUsername(String username) {
        ...
        try (Connection conn = DBConnection.getConnection();
            ...
            // Step 1: Bind username.
            stmt.setString(1, username);
            ResultSet rs = stmt.executeQuery();
            
            // Step 2: Map a single row if present.
            if (rs.next()) {
                User user = new User();
    ...
    public List<User> getAllUsers() {
        ...
        try (Connection conn = DBConnection.getConnection();
            ...
            // Step 1: Map result set into user objects.
            while (rs.next()) {
                User user = new User();
                user.setId(rs.getInt("id"));
                user.setUsername(rs.getString("username"));
    ...
    public boolean approveUser(int userId) {
        ...
        try (Connection conn = DBConnection.getConnection();
            ...
            // Step 1: Bind user id and execute update.
