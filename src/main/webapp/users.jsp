...
<%--
  ...
  Route: GET /users (UserServlet forwards to /users.jsp)
  Submit: POST /users (approve action)

  Authorization:
  - Admin only (enforced by UserServlet).

  Requires:
  - requestScope.users
  - requestScope.successMessage / requestScope.errorMessage (optional)
--%>
<!DOCTYPE html>
<html lang="en">
<head>
