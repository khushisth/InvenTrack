...
<%--
  Page: Receipt
  Route: /receipt.jsp (redirected to after successful checkout)

  Requires:
  - sessionScope.user (cashier name)
  - sessionScope.cart (items and totals)

  Notes:
  - Cart is intentionally not cleared on checkout so the receipt can render it.
  - "New Sale" goes to /pos?action=finish which clears the cart.
--%>
<!DOCTYPE html>
<html lang="en">
<head>
