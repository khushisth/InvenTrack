...
<%--
  Page: Login
  Route: GET /login (LoginServlet forwards to /login.jsp)

  Displays:
  - requestScope.errorMessage (invalid credentials, pending approval, etc.)
  - sessionScope.successMessage (one-time message after registration)
--%>
<!DOCTYPE html>
<html lang="en">
<head>
