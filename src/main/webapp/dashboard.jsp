...
<%--
  Page: Dashboard
  Route: GET /dashboard (DashboardServlet forwards to /dashboard.jsp)

  Requires:
  - sessionScope.user (for welcome message)
  - requestScope.totalProducts, lowStockCount, totalRevenue, totalOrders, recentOrders
--%>
<!DOCTYPE html>
<html lang="en">
<head>
