    ...
    <div class="pos-container">
        ...
        <div class="pos-products">
            <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 1.5rem;">
                ...
                <div>
                    <span class="session-pill">${sessionScope.user.fullName} (${sessionScope.role})</span>
                    <a href="${pageContext.request.contextPath}/dashboard" style="color: var(--gray); text-decoration: none; font-size: 0.875rem; margin-right: 0.75rem;">← Back to Dashboard</a>
                    <a href="${pageContext.request.contextPath}/logout" style="color: #DC2626; text-decoration: none; font-size: 0.875rem;">Logout</a>
                </div>
            </div>
        ...
        <div class="pos-cart">
            <div class="cart-header">
                <div>
                    ...
                    <a href="${pageContext.request.contextPath}/cart" style="font-size: 0.75rem; color: var(--primary); text-decoration: none;">View full cart</a>
                </div>
