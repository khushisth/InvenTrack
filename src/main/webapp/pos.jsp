...
<%--
  Page: POS Terminal
  Route: GET /pos (PosServlet forwards to /pos.jsp)

  Requires:
  - requestScope.products (result of search or full list)
  - sessionScope.cart (created by PosServlet if missing)

  Mutations:
  - Adds/removes/clears/checkout are posted to /cart (CartServlet).
--%>
<!DOCTYPE html>
<html lang="en">
<head>
